...
#   global_study.set_user_attr("opt_model_params_keys", list(opt_model_params.keys()))
#   global_study.set_user_attr("opt_fit_params_keys", list(opt_fit_params.keys()))
#   print("search_params(opt_params):\n", opt_params)
  ...
  for i, local_study in enumerate(local_studies):
    ...
    local_study.optimize(lambda trial: local_opt(trial=trial,
            model_name=model_name, opt_model_params=opt_model_params,
